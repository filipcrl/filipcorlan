...
The board is intended for use with the XEM7360 module from Opal Kelly, which we use to interface with the chip via USB. I am currently updating my old FPGA design to work with this new board and integrate its new features.
